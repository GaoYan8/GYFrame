...
import com.gy.gylibrary.okhttplib.bean.CallbackMessage;
import com.gy.gylibrary.okhttplib.bean.DownloadMessage;
import com.gy.gylibrary.okhttplib.bean.ProgressMessage;
import com.gy.gylibrary.okhttplib.bean.UploadMessage;
import com.gy.gylibrary.okhttplib.callback.BaseActivityLifecycleCallbacks;
import com.gy.gylibrary.okhttplib.callback.BaseCallback;
import com.gy.gylibrary.okhttplib.callback.CallbackOk;
                ...
                case RESPONSE_CALLBACK://网络请求
                    ...
                    if(null != callMsg.callback){
                        ...
                        if(!BaseActivityLifecycleCallbacks.isActivityDestroyed(callMsg.requestTag)){
                            ...
                            } else if(callback instanceof com.gy.gylibrary.okhttplib.callback.Callback){
                                HttpInfo info = callMsg.info;
                                if(info.isSuccessful()){
                                    ((com.gy.gylibrary.okhttplib.callback.Callback)callback).onSuccess(info);
                                }else{
                                    ((com.gy.gylibrary.okhttplib.callback.Callback)callback).onFailure(info);
                                }
