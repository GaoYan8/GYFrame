 ...
 * @Describe
 */
public class GYRatingBar extends LinearLayout {
     ...
     * @param attrs
     */
    public GYRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if(null == starEmptyDrawable){
            starEmptyDrawable= getResources().getDrawable(R.mipmap.img_stars_empty);
        }
        if(null == starFillDrawable){
            starFillDrawable= getResources().getDrawable(R.mipmap.img_stars_full);
        }
        if(null == starHalfDrawable){
            starHalfDrawable= getResources().getDrawable(R.mipmap.img_stars_half);
        }
