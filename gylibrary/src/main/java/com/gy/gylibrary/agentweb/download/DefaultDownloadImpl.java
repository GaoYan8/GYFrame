...
package com.gy.gylibrary.agentweb.download;
...
import com.gy.gylibrary.agentweb.core.AbsAgentWebUIController;
import com.gy.gylibrary.agentweb.core.Action;
import com.gy.gylibrary.agentweb.core.ActionActivity;
import com.gy.gylibrary.agentweb.core.AgentWebConfig;
import com.gy.gylibrary.agentweb.core.AgentWebPermissions;
import com.gy.gylibrary.agentweb.core.AgentWebUtils;
...
public class DefaultDownloadImpl implements android.webkit.DownloadListener {
	 ...
	 */
	private ConcurrentHashMap<String, com.gy.gylibrary.agentweb.download.DownloadListener> mDownloadListeners = new ConcurrentHashMap<>();
	...
	private void preDownload(String url) {
		...
		com.gy.gylibrary.agentweb.download.DownloadListener downloadListener = mDownloadListeners.get(extraService.getUrl());
		// true 表示用户取消了该下载事件。
...
//                mContext.getPackageManager().resolveActivity(mIntent)
	...
	private DownloadListenerAdapter mDownloadAdapter = new DownloadListenerAdapter() {
		...
		public void onProgress(String url, long downloaded, long length, long useTime) {
			...
			com.gy.gylibrary.agentweb.download.DownloadListener downloadingListener = DefaultDownloadImpl.this.mDownloadListeners.get(url);
		...
		public boolean onResult(Throwable throwable, Uri path, String url, com.download.library.Extra extra) {
			com.gy.gylibrary.agentweb.download.DownloadListener downloadListener = mDownloadListeners.remove(url);
	...
	public static DefaultDownloadImpl create(@NonNull Activity activity,
	                                         ...
	                                         @Nullable com.gy.gylibrary.agentweb.download.DownloadListener downloadListener,
