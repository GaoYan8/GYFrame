 ...
 * @author zhousf
 */
public class HttpActivity extends AppCompatActivity implements RequestDisplayHandler.CallBack {
     ...
     * @param callback 结果回调接口
     */
    protected void doHttpAsync1111(HttpInfo info, final Callback callback) {
        getMainHandler().sendEmptyMessage(SHOW_DIALOG);
